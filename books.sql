...
/* 3 */
insert into Book values ("Fundamentos de programación",
						"Facultad de Informática Universidad Complutense",
                        "Este libro es parte de la Facultad de Informática Universidad Complutense, enseñado en el primer curso proporciona al estudiante de las herramientas necesarias para desempeñarse en el area de la programación",
                        "https://www.fdi.ucm.es/profesor/luis/fp/FP.pdf",
                        "scie",
                        0,
                        "https://www.agapea.com/McGraw-Hill-Interamericana-de-Espana-S-A-/Fundamentos-de-programacion-i1n1402963.jpg");
